...
void FXAA::Render(GraphicsCommandList commandList, Texture &input, UINT width, UINT height)
{
	...
	float inverseScreenSize[2] = {1.0f / width, 1.0f / height};
...
void FXAA::BuildPSO()
{
	auto VSByteCode = Utils::CompileShader(L"shaders\\fxaa.hlsl", nullptr, L"VS", L"vs_6_6");
	auto PSByteCode = Utils::CompileShader(L"shaders\\fxaa.hlsl", nullptr, L"PS", L"ps_6_6");
